...
<ul>
    ...
    <li>Locate the child element <tt>HyraxBaseUrl</tt>.<br />
...
&lt;/HyraxMetrics&gt;
    ...
    <li>
        ...
        valid URL) will disable all Hyrax access metrics.<br />
        <pre>
// Do nothing
&lt;HyraxMetrics&gt;
...
&lt;/HyraxMetrics&gt;
    ...
    <li>
        If you wish of your server to participate in the OPeNDAP Inc.'s access pattern analysis project then
